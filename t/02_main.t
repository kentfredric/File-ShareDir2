...
use_ok( 'File::ShareDir2', 'module_dir', 'module_file', 'dist_dir', 'dist_file', 'class_file', );

#####################################################################
# Support Methods

is( File::ShareDir2::_MODULE('File::ShareDir2'), 'File::ShareDir2', '_MODULE returns correct for known loaded module', );
is( File::ShareDir2::_DIST('File-ShareDir2'),    'File-ShareDir2',  '_DIST returns correct for known good dist', );
